...
<p class="bg-dark text-white p-2 radius-5" style=" border-radius: 10px;">Enter the Course Id to View the Lessonss</p>
   <form action="" class="mt-3 form-inline d-print-none">
      <div class="form-group mr-3">
         <label for="checkid">Enter Course ID: </label>
         <input type="text" class="forn-control ml-3" id="checkid" name="checkid">
...
<h3 class="mt-5 bg-dark text-white p-2" style=" border-radius: 10px;">Course ID: <?php if(isset($row['course_id'])){
